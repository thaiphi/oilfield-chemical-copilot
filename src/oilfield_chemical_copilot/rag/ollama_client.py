    ...
    def generate(
        ...
        *,
        ...
        if self._adapter is None:
            ...
            self._adapter = OllamaAnswerClient(model=self.model, client=client)
...
def _parse_and_validate_draft(output_text: str, allowed_source_ids: set[str]) -> RagDraft:
    ...
    draft = RagDraft(
        ...
        why_this_matters=_required_string(payload, "why_this_matters"),
        cited_source_ids=_required_string_list(payload, "cited_source_ids"),
        recommended_next_checks=_required_string_list(payload, "recommended_next_checks"),
