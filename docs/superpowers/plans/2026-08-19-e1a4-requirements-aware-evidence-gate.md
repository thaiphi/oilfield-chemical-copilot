...
| 2. Fresh E1a-4 population contracts and private population | `BLOCKED` | Reconciliation and both correction proposals remain verified. The bounded Iron Sulfide supplement audit froze 252 eligible pages across 17 PDFs and stopped after a 10-page prefix with seven proposed foundational promotions, three retained supporting pages, and zero unresolved decisions. Its stricter v2 seal passed separate verification and independent review with no findings. The combined no-write projection satisfies all eight topic/role strata and the exact 96-slot allocator succeeds, but neither proposal has been applied and no E1a-4 sampling-frame file was written. Explicit authorization to apply the proposals and seal the population is the next gate. |
...
**Iron Sulfide supplement follow-up:** the user-approved follow-up audited only fresh, substantive, supporting-role pages from the already approved supplement folder. It froze 252 eligible pages across 17 authenticated PDFs, reviewed the deterministic 10-page prefix, proposed seven foundational promotions, retained three pages as supporting, and closed with no second-review items. Its stricter private v2 proposal and manifests passed separate no-write verification, freezing the exact source-root identity and authenticating the approved core v2 proposal from the same SQLite database and reconciliation snapshot. The earlier supplement v1 seal is preserved as superseded history. The combined projection satisfies all eight strata and makes the exact 96-slot allocation available. Independent review approved the corrections with no findings. Neither proposal has been applied and no population or sampling-frame artifact exists; explicit authorization for mapping application and population sealing remains required.
...
- [ ] Seal the metadata-only E1a-4 source register and exact 96-slot allocation after database and index prerequisites pass.
  ...
  - **Updated 2026-08-26 after the foundational-locator audit:** the independently approved proposal would make foundational scale, corrosion, and paraffin sufficient, but foundational Iron Sulfide remained at 5 of 12 fresh locators. The exact allocation was unavailable at that checkpoint, which led to the separately approved supplement audit below.
  - **Updated 2026-08-27 after the supplement audit:** the approved existing supplement corpus yielded seven proposed foundational Iron Sulfide promotions in the deterministic 10-page prefix. The stricter private v2 seal and combined no-write projection verify, all eight strata are sufficient, and the exact 96-slot allocator succeeds. Independent review approved the corrections with no findings. Both proposals remain unapplied and no sampling frame was written; require explicit authorization before applying mappings or sealing the private population.
